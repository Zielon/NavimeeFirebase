...
public class FoursquareDetailsQuery extends Query<FoursquarePlaceDetails, FoursquareConfiguration, PlacesParams> {
    ...
    @Override
    public Future<FoursquarePlaceDetails> execute(PlacesParams params) {
